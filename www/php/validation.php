...
$_SESSION['file_name'] = $_FILES['upload']['name'];
$file_dist = __DIR__.'/downloads/'.$_SESSION['file_name'];
$imageFileType = pathinfo(basename ($_SESSION['file_name']), PATHINFO_EXTENSION);
